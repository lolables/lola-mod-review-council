...
phase's scoping-hint rule where it legitimately applies, then write your
decisions back into `.rc-session/verdicts/findings.json` and
`.rc-session/verdicts/disposition.txt` per that phase's Steps 3-5. The
